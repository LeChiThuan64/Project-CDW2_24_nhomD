...
<body>
    ...
    <div class="container">
        <div class="tabs">
            <div id="login-tab" class="<?php echo e(Request::is('login') ? 'active' : ''); ?>">LOGIN</div>
            <div id="register-tab" class="<?php echo e(Request::is('register') ? 'active' : ''); ?>">REGISTER</div>
        </div>

        <?php echo $__env->yieldContent('content'); ?> <!-- Sử dụng yield để hiển thị nội dung đăng nhập hoặc đăng ký -->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('login-tab').addEventListener('click', function() {
                window.location.href = "<?php echo e(route('login')); ?>"; // Điều hướng đến trang login
            });

            document.getElementById('register-tab').addEventListener('click', function() {
                window.location.href = "<?php echo e(route('register')); ?>"; // Điều hướng đến trang register
            });
...
</html><?php /**PATH C:\xampp\htdocs\Project-CDW2_24_nhomD\resources\views/viewUser/navLogin_Register.blade.php ENDPATH**/ ?>