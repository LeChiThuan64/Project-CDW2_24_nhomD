             ...
             <div class="row">
                             ...
                             <div class="swiper-container">
                                 <div class="swiper-wrapper">
                                     ...
                                     <div class="swiper-slide product-single__image-item">
                                         <img loading="lazy" class="h-auto" src="<?php echo $product['image_0']; ?>" width="674"
                                             height="674" alt="">
                                         <a data-fancybox="gallery" href="<?php echo $product['image_0']; ?>" data-bs-toggle="tooltip"
                                     ...
                                     <!-- Các hình ảnh khác -->
                                     <div class="swiper-slide product-single__image-item">
                                         <img loading="lazy" class="h-auto" src="<?php echo $product['image_1']; ?>" width="674"
                                             height="674" alt="">
                                         <a data-fancybox="gallery" href="<?php echo $product['image_1']; ?>" data-bs-toggle="tooltip"
                                             data-bs-placement="left" title="Zoom">
                                             <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                 <use href="#icon_zoom" />
                                     ...
                                     <div class="swiper-slide product-single__image-item">
                                         <img loading="lazy" class="h-auto" src="<?php echo $product['image_2']; ?>" width="674"
                                             height="674" alt="">
                                         <a data-fancybox="gallery" href="<?php echo $product['image_2']; ?>" data-bs-toggle="tooltip"
                                             data-bs-placement="left" title="Zoom">
                                             <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                 <use href="#icon_zoom" />
                                     ...
                                     <div class="swiper-slide product-single__image-item">
                                         <img loading="lazy" class="h-auto" src="<?php echo $product['image_3']; ?>" width="674"
                                             height="674" alt="">
                                         <a data-fancybox="gallery" href="<?php echo $product['image_3']; ?>" data-bs-toggle="tooltip"
                                             data-bs-placement="left" title="Zoom">
                                             <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                 <use href="#icon_zoom" />
                             ...
                             <div class="swiper-container">
                                 <div class="swiper-wrapper">
                                     <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                             src="<?php echo $product['image_0']; ?>" width="104" height="104" alt="">
                                     </div>
                                     <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                             class="h-auto" src="<?php echo $product['image_1']; ?>" width="104" height="104"
                                             alt=""></div>
                                     <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                             class="h-auto" src="<?php echo $product['image_2']; ?>" width="104" height="104"
                                             alt=""></div>
                                     <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                             class="h-auto" src="<?php echo $product['image_3']; ?>" width="104" height="104"
                                             alt=""></div>
                                 </div>
                             </div>
                         </div>
                 ...
                 <div class="col-lg-5">
                  ...
                  <a href="product3_external.html" class="text-uppercase fw-medium"><span class="menu-link menu-link_us-s">Next</span><svg class="mb-1px" width="10" height="10" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg"><use href="#icon_next_md" /></svg></a>
                     ...
                     <h1 class="product-single__name"><?php echo $product['name']; ?></h1>
                     ...
                     <div class="product-single__rating">
                         <div class="reviews-group d-flex">
                             ...
                             for ($i = 0; $i < 5; $i++) {
                                 echo '<svg class="review-star" viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">';
                                 if ($i < $averageRating) {
                                     echo '<use href="#icon_star" />'; // Sao đầy
                                 } else {
                                     echo '<use href="#icon_star_empty" />'; // Sao trống
                                 }
                                 echo '</svg>';
                             }
                             ?>
                         </div>
                         <span class="reviews-note text-lowercase text-secondary ms-1"><?php echo $reviewCount; ?>
                             reviews</span>
                         <!-- <span class="reviews-note text-lowercase text-secondary ms-1"><?php echo $product['reviews']; ?> reviews</span> -->
                     </div>
                                ...
                                if (!empty($reviews)) {
                                 ...
                                 <div class="product-single__reviews-item">
                                     <div class="customer-avatar">
                                         ...
                                         <!-- <img loading="lazy" src="<?php echo !empty($review['avatar']) ? $review['avatar'] : 'images/avatar.jpg'; ?>" alt=""> -->
                                     </div>
                                         ...
                                         <div class="customer-name">
                                             ...
                                             <div class="reviews-group d-flex">
                                                 ...
                                                 for ($i = 0; $i < $review['rating']; $i++) {
                                                     echo '<svg class="review-star" viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">';
                                                     echo '    <use href="#icon_star" />';
                                                     echo '</svg>';
                                                 }
                                                 // Nếu ít hơn 5 sao, hiển thị các sao trống
                                                 for ($i = $review['rating']; $i < 5; $i++) {
                                                     echo '<svg class="review-star" viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">';
                                                     echo '    <use href="#icon_star_empty" />'; // Giả sử có biểu tượng sao trống
                                                     echo '</svg>';
                                                 }
                                                 ?>
                                             </div>
