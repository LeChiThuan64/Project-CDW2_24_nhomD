...
<div class="container bg">
    ...
    @endif
    <form id="updateForm" method="POST" action="{{ route('products.update', $product->product_id) }}" enctype="multipart/form-data">
        @csrf
        <div class="bordered">
            <div class="row">
                <div class="col-md-8">
                ...
                <!-- Upload hình ảnh -->
                <div class="col-md-4">
                    <div class="row mb-3 justify-content-center" id="imagePlaceholderContainers">
                      <img src="" alt="">
                    </div>
                    <div class="row">
                        <div class="col-12 text-center">
                            <input type="file" name="images[]" id="imageInputs" accept="image/jpeg, image/png" multiple class="btn btn-outline-secondary mb-2" style="display: none;">
                            <button class="btn btn-outline-secondary mb-2" id="chooseImageButtons">Chọn ảnh</button>
                            <p class="file-info">Dung lượng file tối đa 1 MB<br>Định dạng: .JPEG, .PNG</p>
                            <input type="hidden" id="imageNamesx" name="imageNamesx" value="">
                        </div>
                    </div>
                </div>
...
<script>
    // Define the variable as a global JavaScript object
    
    window.productSizeColors = @json($productSizeColors);
