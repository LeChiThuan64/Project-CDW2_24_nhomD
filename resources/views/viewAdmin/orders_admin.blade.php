                        ...
                        <tr>
                            ...
                            <td>
                                @if ($order->status === 'pending')
                                    <button class="btn btn-success btn-orders-confirm" data-order-id="{{ $order->id }}">Xác nhận
                                        đơn hàng</button>
                                ...
                                @elseif ($order->status === 'cancelled')
                                    <button class="btn btn-danger btn-orders-delete" data-order-id="{{ $order->id }}">Xóa đơn
                                        hàng</button>
                                @endif
                            </td>
                        </tr>
                ...
                <div class="error-report-box">
                    ...
                    <form id="errorReportForm">
                        ...
                        <button type="button" id="submitErrorReport" class="btn btn-success mt-3">Gửi báo
                            lỗi</button>
                        <button type="button" id="closeErrorReportForm" class="btn btn-secondary mt-3">Đóng</button>
                    </form>
                </div>
            </div>
        </div>
